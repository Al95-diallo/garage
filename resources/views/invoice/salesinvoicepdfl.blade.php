						...
						<tr>
							...
							<td valign="top" style="valign:top;float:left; width:50%;" width="50%">
								...
								<b>{{ trans('app.Status :')}}</b><?php if($invioce->payment_status == 0)
										...
										{echo"Unpaid";}
									 echo "<hr/>"?>
								<b>{{ trans('app.Sale Amount :')}} GNF</b> <?php echo number_format($invioce->grand_total, 2); echo "<hr/>"?>
							</td>
						</tr>
					</tbody>
				</table>
				...
				<table class="table table-bordered itemtable" width="100%" border="1" style="border-collapse:collapse;">
					<thead>
						<tr class="printimg">
							...
							<th align="center" style="padding:8px;">{{ trans('app.Amount')}} GNF</th>
						</tr>
				  ...
				  <?php } ?>
						...
						<?php	}
							...
							?>	
							<tr>
								<td align="right" style="padding:8px;"><b>{{ trans('app.Grand Total')}} GNF :</b></td>
