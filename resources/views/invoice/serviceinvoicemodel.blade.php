         ...
         <div class="row">
                  ...
                  <table class="table table-bordered adddatatable" border="1" style="border-collapse:collapse;">
                     <thead>
                        <tr>
                           ...
                           <th class="text-center">{{ trans('app.Price')}} GNF</th>
                           <th class="text-center">{{ trans('app.Quantity')}} </th>
                           <th class="text-center">{{ trans('app.Total Price')}} GNF </th>
                        </tr>
                     </thead>
                     <tbody>
                        <?php 
            ...
            <!-- For Custom Field End -->
                  ...
                  <table class="table table-bordered" style="border-collapse:collapse;">
                     ...
                     <tr>
                        <td class="text-right cname"><b>{{ trans('app.Total Service Amount')}} GNF:</b></td>
                     ...
                     <tr>
                        <td class="text-right cname" ><b>{{ trans('app.Total')}} GNF :</b></td>
                     ...
                     <?php 
                        ...
                        ?>
                     <tr>
                        <td class="text-right cname" ><b>{{ trans('app.Grand Total')}} GNF :</b></td>
					 ...
					 <tr>
                        <td class="text-right cname"><b>{{ trans('app.Adjustment Amount')}} GNF :</b></td>
                        <td class="text-center cname"><b><?php $paid_amount; echo number_format($paid_amount, 2);?></b></td>
                     </tr>
					 
					 <tr>
                        <td class="text-right cname" ><b>{{ trans('app.Amount Due') }} GNF :</b></td>
