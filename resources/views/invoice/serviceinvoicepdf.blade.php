		...
		<div class="row " id="invoice_print">
						...
						<tr>
					  		<td  width="15%" style="vertical-align:top;float:left; width:15%;" align="left" >
					   		...
					   		<td valign="top" style="valign:top;float:left; width:50%;" width="50%">
								...
								<b>{{ trans('app.Address:')}}</b>  <?php echo $customer->address; echo", "; echo (getCityName("$customer->city_id") != null) ? getCityName("$customer->city_id") .", ":''; ?><?php echo getStateName("$customer->state_id,");echo", ";echo getCountryName($customer->country_id); echo "<hr/>"?>
								<b>{{ trans('app.Contact:')}}</b> <?php echo"$customer->mobile_no";  echo "<hr/>"?>
								<b>{{ trans('app.Email :')}}</b> <?php echo $customer->email;  echo "<hr/>" ?>
								<b>{{ trans('app.Date')}} :</b> <?php echo date(getDateFormat(),strtotime($service_tax->date));  echo "<hr/>"; ?>							
					   		</td>
						</tr>
				 	</tbody>
			  	</table>
			  	...
			  	<table class="table table-bordered" border="1" width="100%" style="border-collapse:collapse;">
				 	...
				 	<tbody class="itemtable">
						<tr>
					   		...
					   		<th align="center" style="padding:8px;">{{ trans('app.Coupon Number')}}</th>
						...
						<tr>
					   		...
					   		<td align="center" style="padding:8px;"><?php if(!empty($job->coupan_no)){echo $job->coupan_no;} else{ echo "Paid Service";} ?></td>
					   		<td align="center" style="padding:8px;"><?php echo getVehicleName($job->vehicle_id) ?></td>
					   		<td align="center" style="padding:8px;"><?php echo getVehicleNumberPlate($job->vehicle_id); ?> </td>
						...
						@foreach($tbl_custom_fields_customers as $tbl_custom_fields_customer)  
		                    ...
		                    @if($tbl_custom_fields_customer->type == "radio")
								...
								<tr>
									...
									<td align="center" style="padding:8px;">{{$radio_selected_value}}</td>
								</tr>
								@else
								<tr>
									<th align="center" style="padding:8px;">
			  	...
			  	<table class="table table-bordered itemtable" width="100%" border="1" style="border-collapse:collapse;">
				 	...
				 	<tbody>
						...
						<tr>
					   		...
					   		<th align="center" style="padding:8px;">{{ trans('app.Price')}} GNF</th>
					   		<th align="center" style="padding:8px;">{{ trans('app.Quantity')}} </th>
					   		<th align="center" style="padding:8px;">{{ trans('app.Total Price')}} GNF </th>
						</tr>
						<?php 
					   		$total1=0;
					   		$i = 1 ;
				...
				<table class="table table-bordered itemtable" width="100%" border="1" style="border-collapse:collapse;">
					<tbody>
						...
						<tr>
						   	...
						   	<th align="center" style="padding:8px;">{{ trans('app.Product Name')}}</th>
						   	<th align="center" style="padding:8px;" colspan="2">{{ trans('app.Price')}} GNF</th>
						   	<th align="center" style="padding:8px;">{{ trans('app.Total Price')}} GNF </th>
						</tr>
						<?php 
						   $total2=0;
			...
			<!-- For Custom Field Of Service Module-->
				@if(!empty($tbl_custom_fields_service))
					...
					<table class="table table-bordered itemtable" width="100%" border="1" style="border-collapse:collapse;">
						<tr class="printimg" style="background-color:#4E5E6A; color:#fff; border-right: 0px;border-left: 0px;">
						   <th align="center" style="padding:8px; font-size:14px; border-right: 0px;border-left: 0px;" colspan="2">
							   {{ trans('app.OTHER INFORMATION OF SERVICE') }}
							</th>
						</tr>
			...
			<!-- For Custom Field Service Module End -->
				...
				<table class="table table-bordered itemtable" width="100%" border="1" style="border-collapse:collapse;">
					...
					<tbody>
						<tr>
						   	<td align="right" style="padding:8px;" width="80%"><b>{{ trans('app.Total Service Amount')}} GNF :</b></td>
						...
						<tr>
						   	<td align="right" style="padding:8px;" width="80%"><b>{{ trans('app.Total')}} GNF :</b></td>
						...
						?>
						<tr>
						   	<td align="right" style="padding:8px;" width="80%"><b>{{ trans('app.Grand Total')}} FNG :</b></td>
