      ...
      <table id="adddatatable4" class="table table-bordered adddatatable" width="100%" border="1" style="border-collapse:collapse;">
         <thead>
            <tr class="printimg">
				...
				<th class="text-center cname">{{ trans('app.Amount')}} GNF</th>
            </tr>
         </thead>
         <tbody>
            <tr>
			...
			<?php  
			 ...
			 <tr>
				<td class="text-right cname" width="81.5%"><b>{{ trans('app.Adjustment Amount')}} GNF :</b></td>
				<td class="text-right cname"><b><?php $paid_amount; echo number_format($paid_amount, 2);?></b></td>
			 </tr>
			 
			 <tr>
				<td class="text-right cname" width="81.5%"><b>{{ trans('app.Amount Due') }} GNF :</b></td>
