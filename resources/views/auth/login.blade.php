...
<body class="login" style="background-image: url('img/garage.jpg')">
      ...
      <div class="login_wrapper">
        ...
        <div class="animate form login_form">
            ...
            <form class="form-horizontal" method="POST" action="{{ url('/login') }}">
              ...
              <h1 class="logintextcolor">Authentification</h1>
          ...
          @endif
              ...
              <div class="separator">
				<p class="change_link ">
                  <a href="{{url('/password/reset')}}" class="to_register logintextcolor"> Mot de passe oublié </a>
                </p>
